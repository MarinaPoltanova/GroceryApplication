package com.example.searchcuisineappliction.data.repository

import android.content.Context
import com.example.searchcuisineappliction.data.Constance
import com.example.searchcuisineappliction.data.DataInfo
...
class RecipeRepositoryImpl: RecipeRepository {
    ...
    override fun getRecipeItems(): MutableList<RecipeItem>{
...
//                )
//            ))
        val recipeItemData = DataInfo().recipeItems
        return recipeItemData
//        return getRecipeItems()
    }

    override fun getCountryItaly(): CountryFoodListModel {
        val countryCusineItaly = DataInfo().countryItaly
        return CountryFoodListModel(countryCusineItaly)
//        return getCountryItaly()
    }

    override fun getCountryUkrine(): CountryFoodListModel {
        val countryCusineUkrine = DataInfo().countryUkrine
        return CountryFoodListModel(countryCusineUkrine)
//        return getCountryUkrine()
    }

    override fun getCountryArmeny(): CountryFoodListModel {
        val countryCusineArmeny= DataInfo().countryArmeny
        return CountryFoodListModel(countryCusineArmeny)
//        return getCountryArmeny()
    }

    override fun getCountryAmerica(): CountryFoodListModel {
        val countryCusineAmerica = DataInfo().countryAmerica
        return CountryFoodListModel(countryCusineAmerica)
//        return getCountryAmerica()
    }

    override fun getCountryVengria(): CountryFoodListModel {
        val countryCusineVengria = DataInfo().countryVengria
        return CountryFoodListModel(countryCusineVengria)
//        return getCountryVengria()
    }


    override fun getFreeIngredient(): FreeIngredientsModel {
        return getFreeIngredient()
    }

    override fun setCollectedGroceryList(setParams: CollectedGroceryListModel):  Boolean{
       return true
    }

    override fun setFavoriteFood(setParams: FavoriteFoodModel): Boolean {
        return true
    }

    override fun getRecipeInfo(): FinalRecipeModel {
